...
const mockORTC = require('rtcpeerconnection-shim/test/ortcmock');
const mockGetUserMedia = require('rtcpeerconnection-shim/test/gummock');
const shimPeerConnection = require('rtcpeerconnection-shim');
